  ...
  },
  {
    ...
    political_landscape: {
      ...
      executiveMembers: [
        ...
        { name: 'Alessia Cappello', role: 'assessor', roleTitle: 'Sviluppo Economico e Politiche del Lavoro', icon: '💼' },
        { name: 'Arianna Censi', role: 'assessor', roleTitle: 'Mobilità', icon: '🚇' },
        { name: 'Emmanuel Conte', role: 'assessor', roleTitle: 'Risorse Finanziarie, Economiche e Patrimoniali', icon: '💰' },
        ...
        { name: 'Martina Riva', role: 'assessor', roleTitle: 'Sport, Turismo e Politiche Giovanili', icon: '⚽' },
        { name: 'Gaia Romani', role: 'assessor', roleTitle: 'Decentramento, Quartieri e Partecipazione, Servizi Civici e Generali', icon: '🏘️' },
        { name: 'Tommaso Sacchi', role: 'assessor', roleTitle: 'Cultura', icon: '🎭' },
        { name: 'Giancarlo Tancredi', role: 'assessor', roleTitle: 'Rigenerazione Urbana', icon: '🏗️' },
      ],
      nextElection: {
        date: '2027-03-15',
      },
      electionHistory: [
        ...
        },
        {
          ...
          turnout: 67.56,
          results: [
            { coalition: 'Sala', percentage: 57.73, color: '#D32F2F' },
            { coalition: 'Bernardo', percentage: 31.97, color: '#1B5E20' },
            { coalition: 'Paragone', percentage: 2.99, color: '#D32F2F' },
            { coalition: 'Pavone', percentage: 2.7, color: '#D57C00' },
            { coalition: 'Mariani', percentage: 1.57, color: '#D32F2F' },
          ],
        },
        {
          date: '2016-06-05',
          turnout: 67.56,
          results: [
            { coalition: 'Sala', percentage: 41.7, color: '#D32F2F' },
            { coalition: 'Parisi', percentage: 40.78, color: '#1B5E20' },
            { coalition: 'Corrado', percentage: 10.06, color: '#D32F2F' },
            { coalition: 'Rizzo', percentage: 3.56, color: '#D32F2F' },
            { coalition: 'Cappato', percentage: 1.88, color: '#D32F2F' },
            { coalition: 'Mardegan', percentage: 1.12, color: '#D32F2F' },
          ],
        },
        {
          date: '2011-05-15',
          turnout: 67.56,
          results: [
            { coalition: 'Pisapia', percentage: 48.05, color: '#D32F2F' },
            { coalition: 'Moratti', percentage: 41.59, color: '#1B5E20' },
            { coalition: 'Palmeri', percentage: 5.54, color: '#F57C00' },
            { coalition: 'Calise', percentage: 3.23, color: '#D57C00' },
            { coalition: 'Pagliarini', percentage: 0.64, color: '#000000' },
          ],
        },
      ],
    },
