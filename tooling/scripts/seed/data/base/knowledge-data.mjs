...
Public Transport,65000,0.4,Buses trams official transit vehicles`,
  ...
  {
    title: 'Area C Tariffe e Orari',
    description: 'Parametri operativi di Area C: tariffe di accesso, orari di applicazione, esenzioni e sanzioni',
    artifact_type: 'parameters',
    state: 'complete',
    content: `tariffa_standard: 7.50 EUR
tariffa_ridotta_serale: 2.00 EUR
tariffa_veicoli_elettrici_2026: 3.00 EUR

orari_applicazione:
  giorni: lunedì-venerdì
  esclusi: festivi
  fascia_principale: 07:30-19:30
  fascia_serale_sperimentale: 19:30-22:00

esenzioni_totali:
  - veicoli elettrici (fino al 31/12/2025)
  - veicoli ibridi plug-in (autonomia >50km)
...
residenti:
  accessi_gratuiti_annui: 40
  tariffa_oltre_quota: 2.00 EUR

sanzioni:
  accesso_non_autorizzato: 83-333 EUR
  mancato_pagamento: 45-180 EUR`,
    sourceDocuments: ['Area C Regulation Amendment 2024'],
    provisions: ['Pedaggi urbani'],
  },
  {
    title: 'Restrizioni Veicolari per Area',
    description: 'Tabella delle classi di veicoli ammessi/vietati in Area C e Area B, con standard emissivi e orari di applicazione',
    artifact_type: 'table',
    state: 'complete',
    content: `area,categoria_veicolo,standard_emissivo,alimentazione,divieto_dal,orario_applicazione
...
2014,45500000,0,2400000
2015,48000000,0,2500000
2016,51000000,0,2600000
2017,54000000,0,2700000
2018,58000000,0,2800000
2019,62000000,0,2900000
2020,28000000,0,1200000
2021,47000000,8500000,2100000
2022,78000000,32000000,2800000
2023,85000000,45000000,3100000`,
    sourceDocuments: [],
    provisions: ['Pedaggi urbani'],
  },
]
