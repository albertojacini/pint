...
export const provisions = [
  {
    ...
    displayChanges: {
      items: [
        { timestamp: '2003-01-15T09:00:00Z', label: '100% stake acquired by City of Milan' },
        { timestamp: '2015-03-20T14:30:00Z', label: 'Metro Line 5 expansion approved' },
        { timestamp: '2020-09-10T11:00:00Z', label: 'New electric bus fleet contract signed' },
        { timestamp: '2023-06-05T16:00:00Z', label: 'Metro Line 4 operational expansion' },
        { timestamp: '2025-03-15T10:00:00Z', label: 'New fare structure for seniors implemented' },
        { timestamp: '2025-08-20T14:00:00Z', label: 'Night bus service expansion approved' },
        { timestamp: '2025-11-10T09:00:00Z', label: 'Digital ticketing system upgrade' },
      ],
    },
  },
  {
    ...
    displayChanges: {
      items: [
        { timestamp: '2012-01-16T00:00:00Z', label: 'Area C congestion charge launched' },
        { timestamp: '2020-03-08T00:00:00Z', label: 'Suspended due to COVID-19' },
        { timestamp: '2021-06-14T00:00:00Z', label: 'Reactivated post-COVID' },
        { timestamp: '2023-06-15T00:00:00Z', label: 'EV exemptions extended to 2030' },
        { timestamp: '2025-02-10T00:00:00Z', label: 'Fee increased to €8.00 for 2025' },
        { timestamp: '2025-05-22T00:00:00Z', label: 'Weekend enforcement hours extended' },
        { timestamp: '2025-09-05T00:00:00Z', label: 'Additional entry gates activated' },
        { timestamp: '2025-12-01T00:00:00Z', label: 'Hybrid vehicle exemption removed' },
      ],
    },
  },
  {
...
The Municipal Police conduct regular inspections. Violations may result in permit suspension, fines, or mandatory removal of structures.`,
    ...
    displayChanges: {
      items: [
        { timestamp: '2020-04-20T00:00:00Z', label: 'Emergency expansion during COVID-19' },
        { timestamp: '2022-09-01T00:00:00Z', label: 'Design standards and clearance rules revised' },
        { timestamp: '2024-03-15T00:00:00Z', label: 'Permit renewal process simplified' },
        { timestamp: '2025-04-01T00:00:00Z', label: 'Seasonal permit fees adjusted for inflation' },
        { timestamp: '2025-07-15T00:00:00Z', label: 'New sustainability requirements for furniture materials' },
        { timestamp: '2025-10-20T00:00:00Z', label: 'Digital permit application system launched' },
      ],
    },
  },
]
