    ...
    displayChanges: {
      items: [
        ...
        { timestamp: '2025-01-22T14:00:00Z', label: 'Winter maintenance protocol activated' },
        {
          ...
          label: 'Staff training program for new ticketing system',
        },
        { timestamp: '2025-02-05T09:30:00Z', label: 'Bus route 73 frequency increased' },
        {
          timestamp: '2025-02-12T15:00:00Z',
          label: 'Metro Line 2 station lighting upgrades begin',
        },
        ...
        { timestamp: '2025-03-12T14:00:00Z', label: 'New bus shelter designs unveiled' },
        {
          ...
          label: 'Integration with regional rail ticket system',
        },
        { timestamp: '2025-03-26T16:00:00Z', label: 'Spring service schedule adjustments' },
        {
          timestamp: '2025-04-02T10:30:00Z',
          label: 'Metro Line 3 platform accessibility improvements',
        },
        {
          timestamp: '2025-04-09T13:00:00Z',
          label: 'Real-time crowding data feature added to app',
        },
        ...
        { timestamp: '2025-04-30T09:00:00Z', label: 'Depot modernization project approved' },
        {
          ...
          label: 'Bike rack installations at 20 metro stations',
        },
        ...
        { timestamp: '2025-05-21T11:00:00Z', label: 'Tourist pass options expanded' },
        {
          ...
          label: 'Metro Line 1 extension to Monza feasibility study',
        },
        { timestamp: '2025-06-04T09:30:00Z', label: 'Air conditioning upgrades on tram fleet' },
        {
          timestamp: '2025-06-11T13:00:00Z',
          label: 'Partnership with ride-sharing services announced',
        },
        ...
        { timestamp: '2025-07-16T09:00:00Z', label: 'Metro Line 4 service frequency increased' },
        {
          ...
          label: 'New security cameras installed at key stations',
        },
        ...
        { timestamp: '2025-10-29T11:00:00Z', label: 'Winter operations plan finalized' },
        {
          ...
          label: 'Partnership with universities for student passes',
        },
        { timestamp: '2025-11-12T09:00:00Z', label: 'Digital ticketing system upgrade' },
        {
          timestamp: '2025-11-19T15:00:00Z',
          label: 'Service reliability improvements on Metro Line 2',
        },
        ...
        { timestamp: '2025-12-10T11:00:00Z', label: 'New year service planning begins' },
        {
          ...
          label: 'Annual ridership reaches 800 million passengers',
        },
      ],
    },
    evaluationSummary: {
      ...
      stakeholders: {
        ...
        items: [
          {
            group: 'Utenti trasporto pubblico',
            impact: 'positive',
            size: 'large',
            detail: '800M passeggeri/anno',
          },
          {
            group: 'Dipendenti ATM',
            impact: 'positive',
            size: 'medium',
            detail: 'Stabilità occupazionale',
          },
          {
            group: 'Contribuenti',
            impact: 'negative',
            size: 'large',
            detail: 'Sussidi per deficit',
          },
          {
            group: 'Commercianti',
            impact: 'positive',
            size: 'medium',
            detail: 'Accessibilità clienti',
          },
        ...
        items: [
          {
            ...
            description:
              'Cedere il 30% delle quote ad un partner privato per migliorare efficienza e ridurre il deficit operativo',
            support: 234,
            oppose: 512,
          },
          {
            ...
            description:
              'Creare un unico abbonamento per tutti i trasporti della Lombardia (treni, metro, bus)',
            support: 876,
            oppose: 45,
          },
          {
...
**È a prova di futuro?** Progettata con roadmap 2030. Crescita veicoli elettrici potrebbe ridurre ricavi; potrebbe servire ristrutturazione. Obiettivi climatici probabilmente stringeranno ulteriormente le restrizioni.`,
    ...
    evaluationSummary: {
      ...
      stakeholders: {
        ...
        items: [
          {
            group: 'Residenti centro',
            impact: 'positive',
            size: 'medium',
            detail: 'Meno traffico e inquinamento',
          },
          {
            group: 'Pendolari auto',
            impact: 'negative',
            size: 'large',
            detail: 'Pagano €5/giorno',
          },
          {
            group: 'Trasporto pubblico',
            impact: 'positive',
            size: 'large',
            detail: 'Più finanziamenti e utenti',
          },
          {
            group: 'Commercianti centro',
            impact: 'mixed',
            size: 'medium',
            detail: 'Meno traffico ma anche meno clienti in auto',
          },
          {
            group: 'Proprietari veicoli vecchi',
            impact: 'negative',
            size: 'medium',
            detail: 'Costretti a cambiare veicolo',
          },
          {
            group: 'Ambiente',
            impact: 'positive',
            size: 'large',
            detail: 'PM10 -50%, NOx -11%/anno',
          },
        ],
        confidence: 'high',
      },
...
**Cosa manca?** Studio impatto flussi pedonali, dati monitoraggio livelli rumore, analisi economica effetti su attività vicine.`,
    ...
    displayChanges: {
      items: [
        ...
        { timestamp: '2025-02-21T15:00:00Z', label: 'Digital application portal update' },
        {
          ...
          label: 'Enforcement actions: 12 violations addressed',
        },
        ...
        { timestamp: '2025-07-04T11:00:00Z', label: 'Pedestrian flow study initiated' },
        {
          ...
          label: 'New sustainability requirements for furniture materials',
        },
    ...
    evaluationSummary: {
      ...
      stakeholders: {
        ...
        items: [
          {
            group: 'Ristoratori/bar',
            impact: 'positive',
            size: 'medium',
            detail: '1.247 permessi attivi',
          },
          {
            group: 'Pedoni',
            impact: 'negative',
            size: 'large',
            detail: 'Spazio ridotto sui marciapiedi',
          },
          {
            group: 'Residenti zona locali',
            impact: 'negative',
            size: 'small',
            detail: 'Rumore dopo le 22:00',
          },
          { group: 'Turisti', impact: 'positive', size: 'medium', detail: 'Atmosfera vivace' },
          {
            ...
            impact: 'mixed',
            size: 'small',
            detail: '96% conformità accessibilità',
          },
        ...
        items: [
          {
            ...
            description:
              'Abbassare il canone del 30% per sostenere i piccoli esercizi dopo gli aumenti post-COVID',
            support: 456,
            oppose: 234,
          },
          {
          ...
          },
          {
            ...
            description:
              "Aumentare lo spazio minimo di passaggio da 1,5m a 2m per migliorare l'accessibilità",
            support: 289,
            oppose: 345,
          },
        ],
