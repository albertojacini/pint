...
export const provisions = [
  ...
  },
  {
    ...
    displayChanges: {
      items: [
        { timestamp: '2025-01-09T08:00:00Z', label: 'Annual enforcement statistics published' },
        { timestamp: '2025-01-16T10:00:00Z', label: 'Camera maintenance at Porta Venezia gate' },
        { timestamp: '2025-01-23T14:30:00Z', label: 'Visitor information campaign launched' },
        { timestamp: '2025-01-30T09:00:00Z', label: 'Monthly revenue report: €7.2M' },
        { timestamp: '2025-02-06T11:00:00Z', label: 'Exemption policy clarification published' },
        { timestamp: '2025-02-13T15:00:00Z', label: 'Fee increased to €8.00 for 2025' },
        { timestamp: '2025-02-20T10:30:00Z', label: 'Payment portal system upgrade' },
        { timestamp: '2025-02-27T13:00:00Z', label: 'New signage installed at all entry points' },
        { timestamp: '2025-03-06T09:30:00Z', label: 'Resident permit renewal period begins' },
        { timestamp: '2025-03-13T14:00:00Z', label: 'Enforcement hours extended to 20:00' },
        { timestamp: '2025-03-20T11:00:00Z', label: 'Mobile app payment feature enhanced' },
        { timestamp: '2025-03-27T16:00:00Z', label: 'Traffic reduction metrics: 32% decrease' },
        { timestamp: '2025-04-03T10:00:00Z', label: 'Air quality report shows improvement' },
        { timestamp: '2025-04-10T13:30:00Z', label: 'Camera upgrade at Porta Romana' },
        { timestamp: '2025-04-17T09:00:00Z', label: 'Exemption for car-sharing vehicles reviewed' },
        { timestamp: '2025-04-24T15:00:00Z', label: 'Public consultation on zone expansion begins' },
        { timestamp: '2025-05-01T11:30:00Z', label: 'Monthly revenue report: €7.8M' },
        { timestamp: '2025-05-08T14:00:00Z', label: 'New payment deadline grace period introduced' },
        { timestamp: '2025-05-15T10:00:00Z', label: 'Integration with parking payment system' },
        { timestamp: '2025-05-22T16:30:00Z', label: 'Weekend enforcement hours extended' },
        { timestamp: '2025-05-29T09:00:00Z', label: 'Penalty reduction for early payment launched' },
        { timestamp: '2025-06-05T13:00:00Z', label: 'Camera network expansion announced' },
        { timestamp: '2025-06-12T11:00:00Z', label: 'Exemption database system updated' },
        { timestamp: '2025-06-19T14:30:00Z', label: 'Summer traffic monitoring begins' },
        { timestamp: '2025-06-26T10:00:00Z', label: 'Revenue allocation report published' },
        { timestamp: '2025-07-03T15:00:00Z', label: 'Tourist information materials updated' },
        { timestamp: '2025-07-10T09:30:00Z', label: 'Camera maintenance schedule adjusted' },
        { timestamp: '2025-07-17T13:00:00Z', label: 'Compliance rate reaches 94%' },
        { timestamp: '2025-07-24T11:00:00Z', label: 'New entry gate activated at Porta Ticinese' },
        { timestamp: '2025-07-31T14:00:00Z', label: 'Monthly revenue report: €8.1M' },
        { timestamp: '2025-08-07T10:00:00Z', label: 'Enforcement staff training program' },
        { timestamp: '2025-08-14T16:00:00Z', label: 'Electric vehicle registrations increase 15%' },
        { timestamp: '2025-08-21T09:00:00Z', label: 'Payment reminder system upgraded' },
        { timestamp: '2025-08-28T13:30:00Z', label: 'Zone boundary review initiated' },
        { timestamp: '2025-09-04T11:00:00Z', label: 'Back-to-school traffic monitoring' },
        { timestamp: '2025-09-11T14:00:00Z', label: 'Additional entry gates activated' },
        { timestamp: '2025-09-18T10:30:00Z', label: 'Annual environmental impact assessment' },
        { timestamp: '2025-09-25T15:00:00Z', label: 'Resident feedback survey launched' },
        { timestamp: '2025-10-02T09:00:00Z', label: 'Fall enforcement adjustments' },
        { timestamp: '2025-10-09T13:00:00Z', label: 'Camera system AI enhancement deployed' },
        { timestamp: '2025-10-16T11:30:00Z', label: 'Multi-day pass option introduced' },
        { timestamp: '2025-10-23T14:00:00Z', label: 'Revenue reinvestment plan announced' },
        { timestamp: '2025-10-30T10:00:00Z', label: 'Monthly revenue report: €8.5M' },
        { timestamp: '2025-11-06T16:00:00Z', label: 'Winter enforcement preparations' },
        { timestamp: '2025-11-13T09:30:00Z', label: 'Exemption appeal process streamlined' },
        { timestamp: '2025-11-20T13:00:00Z', label: 'Public transport integration incentives' },
        { timestamp: '2025-11-27T11:00:00Z', label: 'Holiday enforcement schedule published' },
        { timestamp: '2025-12-04T14:30:00Z', label: 'Hybrid vehicle exemption removed' },
        { timestamp: '2025-12-11T10:00:00Z', label: 'Year-end compliance report: 95% rate' },
        { timestamp: '2025-12-18T15:00:00Z', label: 'Annual revenue reaches €95M' },
      ],
    },
  },
  {
