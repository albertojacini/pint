/**
 * Provisions data
 * Each provision represents a relationship of control between political entity and something in its jurisdiction
 * Types: ownership, contract, regulation, taxation, allocation, designation
 */
...
export const provisions = [
...

  {
    ...
    title: "ATM - Azienda Trasporti Milanesi (stake)",
    description: "51% ownership stake in municipal public transport company operating metro, tram, trolleybus, and bus services",
    type: "ownership",
    status: "active",
  ...
  {
    entity: "Comune di Milano",
    title: "AMSA - Azienda Milanese Servizi Ambientali (stake)",
    description: "Ownership stake in urban waste collection and disposal company for Milan and 14 metropolitan municipalities",
    type: "ownership",
    status: "active",
  ...
  {
    entity: "Comune di Milano",
    title: "MM - Metropolitana Milanese (stake)",
    description: "Ownership stake in metro infrastructure management and water services company",
    type: "ownership",
    status: "active",
  ...
  },
  {
    entity: "Comune di Milano",
    title: "A2A (stake)",
    description: "25% ownership stake in multi-utility providing energy, district heating, waste management, and environmental services",
    type: "ownership",
    status: "active",
  ...
  },
  {
    ...
    description: "Municipal agency specializing in mobility, urban design, and climate in urban developments",
    type: "ownership",
    status: "active",
  ...
  },
  {
    ...
    description: "Municipal agency managing housing policies and rental support programs",
    type: "ownership",
    status: "active",
  ...
  {
    entity: "Comune di Milano",
    title: "ATM Service Contract",
    description: "Service agreement with ATM for public transport operations across Milan and 95 Lombardy municipalities",
    type: "contract",
    status: "active",
  ...
  {
    entity: "Comune di Milano",
    title: "AMSA Service Contract",
    description: "Service agreement with AMSA for waste collection and disposal",
    type: "contract",
    status: "active",
    effectiveFrom: "2015-01-01",
    effectiveUntil: null,
  ...
  {
    entity: "Comune di Milano",
    title: "MM Water Services Contract",
    description: "Service agreement with MM for integrated water services management",
    type: "contract",
    status: "active",
  ...
  {
    entity: "Comune di Milano",
    title: "Regolamento Qualità dell'Aria",
  ...
  {
    entity: "Comune di Milano",
    title: "Ordinanza Area B e Area C",
  ...
  {
    entity: "Comune di Milano",
    title: "Obbligo Sensori Angolo Cieco",
  ...
  },
  {
    ...
    description: "Municipal urban planning instrument defining layout of entire municipal territory",
    type: "regulation",
    status: "active",
  ...
  {
    entity: "Comune di Milano",
    title: "Linee Indirizzo Urbanistica ed Edilizia",
  ...
  },
  {
    ...
    description: "Waste tax paid in two semi-annual installments",
    type: "taxation",
    status: "active",
  ...
  {
    entity: "Comune di Milano",
    title: "Tariffa Parcheggio Strisce Blu - Bastioni",
  ...
  {
    entity: "Comune di Milano",
    title: "Area C Access Fee",
    description: "Congestion charge for access to historic center (Cerchia dei Bastioni)",
    type: "taxation",
    status: "active",
  ...
  // ============================================================================
  // DESIGNATION - Zones, landmarks, protected areas
  // ============================================================================

  {
    entity: "Comune di Milano",
    title: "Area C (zone)",
    description: "Limited traffic zone in historic center (Cerchia dei Bastioni), active weekdays 7:30-19:30",
    type: "designation",
    status: "active",
    effectiveFrom: "2012-01-16",
    effectiveUntil: null,
