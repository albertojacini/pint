...
const dimensions: Dimension[] = [
    ...
    debate: (
      <>
        <p>
          ...
          modello accusatorio. Il CNF (Consiglio Nazionale Forense) ha aderito
          all&apos;unanimit&agrave; al comitato per il SI.
        </p>
        <p className="mt-2">
          <strong>Per il polo negativo.</strong> Margherita Cassano (Prima Presidente della Corte di
          Cassazione) cita i dati: solo lo 0,83% dei PM e lo 0,21% dei giudici ha cambiato funzione
          in 5 anni dopo la Cartabia &mdash; la riforma formalizza qualcosa che non esiste
          pi&ugrave;. Gaetano Silvestri (Presidente emerito, Corte Costituzionale) avverte di
          ...
          l&apos;applicazione imparziale della legge.
        </p>
      </>
    ),
    mechanisms: (
    ...
    precedents: (
      <>
        <p>
          ...
          indipendenza del PM coesistono. La Francia ha separazione ma i PM storicamente erano sotto
          l&apos;autorit&agrave; del Ministro. La Spagna nel 2025 ha trasferito i poteri
    ...
    debate: (
      <>
        <p>
          ...
          costituzionale. L&apos;Art. 112 resta invariato. Il Presidente della Repubblica presiede
          entrambi i CSM.
        </p>
        <p className="mt-2">
          ...
          Commissione Europea (Rule of Law Report 2025) segnala che &quot;isolare il servizio del PM
          &egrave; spesso vulnerabile alla politicizzazione&quot;. Il CSM stesso ha votato un parere
          negativo (24 voti). Silvestri avverte di &quot;eterogenesi dei fini&quot;. Schlein (PD):
          &quot;tentativo di sfuggire ai controlli&quot;. Conte (M5S): &quot;disegno pericoloso per
          demolire l&apos;equilibrio dei poteri&quot;.
        </p>
      </>
    ),
    mechanisms: (
      <ul className="list-disc pl-4 space-y-1.5">
        <li>
          ...
          compilata dal Parlamento. La maggioranza politica controlla chi finisce nella lista. Se le
          leggi attuative non richiedono una maggioranza qualificata per la compilazione,
        ...
        <li>
          ...
          rischio di &quot;strumentalizzazione dei procedimenti disciplinari&quot;. La giurisdizione
          su condotte che &quot;compromettono indipendenza e imparzialit&agrave;&quot; &egrave; vaga
          e potrebbe creare un effetto intimidatorio.
        </li>
        <li>
          <strong>Delega in bianco alla legge ordinaria.</strong> Il testo costituzionale &egrave;
          scarno sui dettagli attuativi. Le leggi ordinarie (maggioranza semplice) definiranno:
          priorit&agrave; dell&apos;azione penale, regole disciplinari, procedure del sorteggio,
          rapporto PM-esecutivo. Come avverte il giudice Morosini: questo d&agrave; &quot;a
          maggioranze mutevoli il potere di modellare l&apos;azione penale&quot;.
        </li>
        <li>
          <strong>Contro-argomento: garanzie nel testo.</strong> L&apos;Art. 112 resta invariato. Il
          Presidente della Repubblica presiede entrambi i CSM. Per subordinare i PM servirebbero
          modifiche costituzionali esplicite che questa riforma non contiene (Barbera).
        </li>
      </ul>
    ),
    precedents: (
      <>
        <p>
          <strong>Polonia</strong> (il precedente pi&ugrave; citato). La riforma del 2016 ha
          eliminato l&apos;indipendenza dei PM: riassegnazione discrezionale dei casi, procedimenti
        ...
        <p className="mt-2">
          ...
          <strong> Germania.</strong> PM completamente subordinati al Ministro. Nel 2019 la CGUE ha
          stabilito che non possono essere considerati &quot;autorit&agrave; giudiziaria&quot;.
        </p>
        <p className="mt-2">
          Barbera e Cazzola contestano la comparabilit&agrave;: Francia e Germania hanno norme
          esplicite di subordinazione che la riforma italiana non contiene.
        </p>
      </>
    ),
  },
  {
    ...
    debate: (
      <>
        <p>
          <strong>Per il polo positivo.</strong> Il governo argomenta che due CSM specializzati sono
          pi&ugrave; efficaci di uno generalista. Ogni organo pu&ograve; concentrarsi sulle
          specificit&agrave; della propria funzione. La separazione porta chiarezza organizzativa.
        </p>
        <p className="mt-2">
          <strong>Per il polo negativo.</strong> Nicol&ograve; Zanon (Associazione Italiana dei
          Costituzionalisti) nota un paradosso: creare un CSM separato per i PM &quot;consacra la
          funzione requirente al pi&ugrave; alto livello istituzionale&quot; anzich&eacute;
          separarla. Si chiede se sar&agrave; &quot;facile per il Ministro confrontarsi con due
          CSM&quot;. Propone come alternativa un singolo CSM diviso in sezioni (legge ordinaria). Il
          CSM stesso (parere negativo) identifica &quot;problemi nel rapporto tra competenze dei due
          organi, risoluzione di conflitti, mancanza di visione unitaria&quot;. Bruti Liberati (ex
          Procuratore Capo di Milano): &quot;eliminazione sostanziale del CSM: frammentato in due
          organi non comunicanti&quot;. Maruotti (ANM): l&apos;Alta Corte costerebbe ~20M&euro;/anno
          per ~75 casi.
        </p>
      </>
    ),
    mechanisms: (
      <ul className="list-disc pl-4 space-y-1.5">
        ...
        <li>
          ...
          focalizzati possono essere pi&ugrave; efficaci di uno grande e generalista. La
          suddivisione per funzione &egrave; un principio organizzativo standard.
        </li>
      </ul>
    ),
    precedents: (
      <>
        <p>
          ...
          port&ograve; a un&apos;esplosione di contenziosi alla Corte Costituzionale. Zanon nota che
          le argomentazioni sono prevalentemente strutturali, ma la storia istituzionale italiana
  ...
  },
  {
    ...
    debate: (
      <>
        <p>
          <strong>Per il polo positivo.</strong> Il governo cita lo scandalo Palamara come prova che
          il sistema elettorale del CSM era corrotto. Nordio lo definisce un &quot;verminaio
          correntizio&quot; e un meccanismo &quot;para-mafioso&quot;. Il sorteggio elimina la
          competizione elettorale e quindi le correnti che la organizzano.
        </p>
        <p className="mt-2">
          <strong>Per il polo negativo.</strong> Giuseppe Santalucia (Giustizia Insieme) offre
          l&apos;analisi pi&ugrave; dettagliata: rimuovere la responsabilit&agrave; elettorale non
          previene il correntismo &mdash; lo redistribuisce. Senza strutture di gruppo trasparenti,
          i magistrati costruiscono &quot;reti clientelari personali&quot; senza &quot;obbligo di
          rendere conto ad alcun corpo collettivo&quot;. Edmondo Bruti Liberati (ex Procuratore Capo
          di Milano) prevede direttamente che le correnti &quot;non spariranno&quot;. Andrea Pertici
    ...
    mechanisms: (
      <ul className="list-disc pl-4 space-y-1.5">
        <li>
          <strong>Reti informali al posto di quelle formali.</strong> Santalucia: senza le correnti
          (gruppi trasparenti, organizzati, con programmi pubblici), l&apos;influenza si sposta su
          reti personali opache. L&apos;effetto del correntismo persiste, ma diventa meno visibile e
          meno controllabile.
        </li>
        <li>
          <strong>Erosione della memoria istituzionale.</strong> Membri sorteggiati in carica 4
          anni, non immediatamente riselezionabili. La competenza e la continuit&agrave; si perdono.
          Il personale burocratico permanente guadagna influenza sproporzionata.
        </li>
        <li>
    ...
    precedents: (
      <>
        <p>
          ...
          dell&apos;ufficio valutazione del Senato trov&ograve; che il meccanismo non riusc&igrave;
          a: migliorare la qualit&agrave; della selezione, ridurre il localismo, o prevenire
          commissari inadeguati. I risultati mostrarono solo un &quot;livellamento verso la
          qualit&agrave; media&quot;.
        </p>
        <p className="mt-2">
